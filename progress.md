...
| 엔드포인트 | 상태 |
|-----------|------|
| `/api/earth-now/air-monitors` | `not_configured` (OPENAQ_API_KEY 미등록) |
| `/api/earth-now/sea-level-anomaly` | `not_configured` (CMEMS 미등록) |
| `/api/earth-now/fires` | `not_configured` (FIRMS_MAP_KEY 미등록) |
